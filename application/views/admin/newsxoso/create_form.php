        ...
        <div class="box">
        	<div class="heading">
                ...
                <div class="buttons">
                    ...
                    <a href="javascript:void(0);" onclick="location.href='<?=$this->index_url;?>admin/newsxoso';" class="button">Cancel</a>
                </div>
            </div><!--End heading-->
            <div class="content">
            	<div id="tabs" class="htabs">
                	<a href="#tab_1" class="selected">Thông tin bản tin xổ số</a>
                ...
                <form action="<?=$action;?>" method="post" enctype="multipart/form-data" id="frm_add">
               	  <div id="tab_1" style="display:block;">
						...
						<tbody>
								...
								<tr>
                                  <td width="169" align="left"><label>Thẻ tag:</label><br /><span class="help">Thẻ tag cách nhau bằng dấu phẩy </span></td>
                                    <td width="922">
                                    	<?php if(@$q->title !='') :?>
                                        <input name="tag" type="text" id="tag" value="<?php echo @$q->tag;?>" size="100" />
                                        <?php else : ?>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                  <td align="left"><label>Trạng thái:</label><br /><span class="help"> </span></td>
                                    <td>
