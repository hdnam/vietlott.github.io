<div class="panel panel-default">
     <div class="panel-heading">
        <h4><i class="fa fa-newspaper-o"></i> Tin tức xổ số</h4>
     </div>
        ...
        <div id="area_product">
                <div class="product_list">
                    ...
                    <div class="klw-new-tags clearfix">
                       ...
                       $tag = explode(",", $news->tag);
                       
                       ?>
                        <?php foreach($tag as $listtag) : ?>  
                          <li class="kli"><a title="<?=$listtag;?>" href="<?php echo base_url()."tag/".$this->util->alias($listtag);?>"><strong><?=$listtag;?></strong></a></li>
                          <?php endforeach;?>
                       </ul>
                    </div>
                    <?php } ?>
